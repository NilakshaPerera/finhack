        ...
        <div class="x_content">
            ...
            <form id="formuserupdate" name="formuserupdate" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="email" id="txtlecturer" name="txtlecturer" required="required" value="<?php echo $data['users']->lecturer ?>" class="form-control col-md-7 col-xs-12" >
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="email" id="txtteam_name" name="txtteam_name" required="required" value="<?php echo $data['users']->team_name ?>" class="form-control col-md-7 col-xs-12" >
                    </div>
                </div>
