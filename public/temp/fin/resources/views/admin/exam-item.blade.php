    ...
    <div class="x_panel">
        <div class="container-custom">
            ...
            <div class="mb-5">
                ...
                if (empty($tempo)) {
                    ?>
                    <p><font size="3">The candidate has not uploaded the Presentation.</font></p>
                <?php } else { ?>      
                ...
                if (empty($tempor)) {
                    ?>  
                    <div>
                        <p><font size="3">The candidate has not uploaded the video.</font></p>
                    </div>
                <?php } else { ?>  
                    <div>
                        <?php
                        ...
                        if ($temp !== 'mp4') {
                            ?>
                            <a  class="badge" target="_blank"  href="{{ url('/') .'/uploads/video-answers/' . $exam->presentation['vid'] }}">Video Answer Attachment</a>
                            <br>
                        <?php } else { ?>
