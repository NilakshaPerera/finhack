            ...
            <div class="row">
                <div class=" col-md-12">
                    ...
                    <h5 class="text-center mb-4" v-for="(item ,  index) in clues" :key="index">
                       <p  class="text-center mb-4 w-100" v-html="item"></p>
                       </h5>
                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label for="file1" class="btn   acca-btn  ">{{ uploadLabel1 }}</label>
                                            <input  v-on:change="handleFileUpload1()" id="file1" ref="file1" class="file-upload__input" type="file" name="file1" accept="video/3gpp,video/mp4,video/mpeg,video/quicktime,video/webm,video/x-flv,video/x-m4v,video/x-ms-wmv,video/x-msvideo">
                                          <br>
    ...
    handleFileUpload() {
     ...
     handleFileUpload1() {
      ...
      axios
        ...
        .then(function(response) {
          if (response.data.success) {
            currentObj.uploadLabel1 = "Video Uploaded";
            //timer.modalhide();
          } else {
          } 
          timer.modalhide();
