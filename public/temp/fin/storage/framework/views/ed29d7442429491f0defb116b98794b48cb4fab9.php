            ...
            foreach ($sessions as $session) {
                ...
                <div class="col-md-2 exam-block zoom">
                    <a class="" href="<?php echo e(route('admin/exams/item' , $session->id)); ?>">
                        <div>
                            <h4 class="text-center"><?php echo e($session->user->university); ?></h4>
                            <hr>
                            <div class="p-all">
                                <span><b>Lead :</b> <?php echo e($session->user->name); ?></span> </br>
                                <span><b>Lecturer :</b> <?php echo e($session->user->lecturer); ?></span> </br>
                            ...
                            <hr>
                            <div class="p-all">
                                <!-- <span><b>MCQ :</b> <?php echo e(($session->mcq_score == null)? "Not Scored": $session->mcq_score); ?></span> </br>
                                <span><b>Puzzle :</b> <?php echo e(( $session->puzzle_score == null )? "Not Scored": $session->puzzle_score); ?></span> </br> -->
