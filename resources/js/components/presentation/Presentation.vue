  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div id="card-con-wrap" v-bind:style="styleObject2" >
          <h5 class="mb-4" v-for="(item ,  index) in clues" :key="index">
                       <p  class="mb-4 w-100" v-html="item"></p>
                       </h5>
      </div>
      <div class="modal-footer">'
        <div style="">
          <a :href="file_name" target="_blank" class="btn acca-btn float-left" title="Click to download the Case Study File">case Study File</a>
        </div>
        <button type="button"  class="btn acca-btn" data-dismiss="modal">Close</button>
      </div>
    </div>
      ...
      axios
        ...
        .then(function(response) {
          ...
          if (response.data.success) {
           ...
           currentObj.file_name = base + response.data.a.file_name;
