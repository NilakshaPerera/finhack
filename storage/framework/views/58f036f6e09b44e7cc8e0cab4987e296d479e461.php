...
<div class="col-md-12 col-sm-12 col-xs-12">    
    <div class="x_panel">
        ...
        <div class="x_content">
            <form id="formadduser" name="formadduser" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="<?php echo e(route('admin/presentation-update')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="<?php echo e($data['presentation']->name); ?>" id="txttitle" name="txttitle" required="required" value="" class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php echo e($data['presentation']->Body); ?>
                    ...
                    <div id="dynamic-answer-container" name="dynamic-answer-container" class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div id="" name="" class="dynamic-answer" >
                            <div class="col-md-10 col-sm-10 col-xs-11" style="margin-bottom: 5px; padding-left: 0">   
                                <input value="<?php echo e($answer); ?>" name="txtanswers[]" required class="form-control col-md-7 col-xs-12"> 
                            </div>
                ...
                <input id="hash" name="hash" type="hidden" value="<?php echo e($data['presentation']->id); ?>">
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                         <button onclick="window.location = '<?php echo e(url('/admin/presentations')); ?>'" class="btn btn-primary" type="button">Back</button>
